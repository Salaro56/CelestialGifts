...
{
    public class Purple_Double_Phaseblade : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Purple Double Phaseblade");
        ...
        public override void SetDefaults()
        {
            ...
            item.height = 100;    //The size of the height of the hitbox in pixels.
            ...
            item.shoot = mod.ProjectileType<Purple_Force>();  //This defines what type of projectile this weapon will shoot  
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ItemID.PurplePhaseblade, 2);
