...
{
    public class Blue_Double_Phaseblade : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Blue Double Phaseblade");
        ...
        public override void SetDefaults()
        {
            ...
            item.shoot = mod.ProjectileType<Blue_Force>();  //This defines what type of projectile this weapon will shoot  
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ItemID.BluePhaseblade, 2);
