...
{
    public class Red_Double_Phaseblade : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Red Double Phaseblade");
        ...
        public override void SetDefaults()
        {
            ...
            item.shoot = mod.ProjectileType<Red_Force>();  //This defines what type of projectile this weapon will shoot  
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ItemID.RedPhaseblade, 2);
