...
{
    public class Yellow_Double_Phaseblade : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Yellow Double Phaseblade");
        ...
        public override void SetDefaults()
        {
            ...
            item.shoot = mod.ProjectileType<Yellow_Force>();  //This defines what type of projectile this weapon will shoot  
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ItemID.YellowPhaseblade, 2);
