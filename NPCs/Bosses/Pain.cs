...
namespace CelestialGifts.NPCs.Bosses
{
    ...
    public class Pain : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            npc.lifeMax = 200000; // The Max HP the boss has on Normal
        ...
        public override void AI()
        {
            ...
            Move(new Vector2(0, -200)); // Calls the Move Method
            //Attacking
        ...
        public override void FindFrame(int frameHeight)
        {
            ...
            if (frame >= Main.npcFrameCount[npc.type]) frame = 9;
