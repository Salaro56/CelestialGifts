...
namespace CelestialGifts.NPCs.Bosses
{
    ...
    public class Death : ModNPC
    {
        ...
        {
            DisplayName.SetDefault("First Horseman Death");
        }
        ...
        public override void SetDefaults()
        {
            ...
            npc.damage = 100; // The base damage value the boss has on Normal
        ...
        public override void AI()
        {
            ...
            Move(new Vector2(100f, 400f)); // Calls the Move Method
            //Attacking
        ...
        private void Shoot()
        {
            int type = mod.ProjectileType("DeathsGraze");
