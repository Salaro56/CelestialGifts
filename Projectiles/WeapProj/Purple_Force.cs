...
{
    public class Purple_Force : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("The Force");
        }
        ...
        public override void AI()
        {
            ...
            Lighting.AddLight(projectile.Center, 1f, 0f, 1f);     //this is the projectile light color R, G, B (Red, Green, Blue)
