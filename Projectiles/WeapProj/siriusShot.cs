...
namespace CelestialGifts.Projectiles.WeapProj
{
    public class siriusShot : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            Projectile.NewProjectile(projectile.position.X, projectile.position.Y - 20f, 0, 0, mod.ProjectileType<WhiteExplosion>(), (int)(projectile.damage * 0.5f), projectile.knockBack, Main.myPlayer); // 296 is the explosion from the Inferno Fork
