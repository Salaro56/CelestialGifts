...
namespace CelestialGifts.Projectiles.Minions
{
    public abstract class HoverShooter : MinionAI
    {
        ...
        public override void Behavior()
        {
            ...
            //find target position based on mark?
            ...
            //finding position of target and setting target to true
            else
            {
                for (int k = 0; k < 200; k++)
                {
            ...
            if (target && projectile.ai[0] == 0f)
            {
                ...
                {
                    projectile.velocity *= (float)Math.Pow(0.85, 40.0 / inertia);
                }
            }
            //handles finding and following player
            else
            {
            ...
            //
            //timer for handling shoot cooldown
