...
namespace CelestialGifts.Projectiles
{
    public class DivineComet : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                int dust = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, DustID.SolarFlare, projectile.velocity.X * 1.2f, projectile.velocity.Y * 1.2f, 120, default(Color), 2.50f);   //this make so when this projectile disappear will spawn dust, change PinkPlame to what dust you want from Terraria, or add mod.DustType("CustomDustName") for your custom dust
